...
OutDir=/home/connellj/miseq/c_variant_sequencing/2019/qc_dna/paired/fusarium_venenatum/c-varient/assembly/spades/c15/fusarium_venenatum/c-varient/filtered_contigs/filtered/repeat_masked/circos_visualisation

Fv_Illumina_genome=$(ls local_illumina_Fv_genome/WT_contigs_unmasked.fa)
...
C15_genome=$(ls miseq/c_variant_sequencing/2019/qc_dna/paired/fusarium_venenatum/c-varient/assembly/spades/c15/fusarium_venenatum/c-varient/filtered_contigs/filtered/repeat_masked/filtered_contigs_contigs_unmasked.fa)
ProgDir=~/git_repos/scripts/Fv_C-variants/Circos
$ProgDir/fasta2circos.py --genome $C15_genome --contig_prefix "C15" > $OutDir/C15_genome.txt
##chmod 777 for permisions 
  cat $OutDir/Fv_Illumina_genome.txt > $OutDir/Fv_C15_genome.txt
  tac $OutDir/C15_genome.txt >> $OutDir/Fv_C15_genome.txt
...
#  | grep -v -e "A3_5_MINcontig_5" \
  > $OutDir/Fv_C15_genome_edited.txt
