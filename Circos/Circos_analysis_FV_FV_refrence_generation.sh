...
OutDir=/home/connellj/fusarium_venenatum/circos_out/Fv_vs_Fv/refrence_assembly
mkdir -p $OutDir
...
Fv_MINion_genome=$(ls /home/connellj/local_MINion_Fv_genome/WT_albacore_v2_contigs_unmasked.fa)
ProgDir=~/git_repos/scripts/Fv_C-variants/Circos
...
OutDir=/home/connellj/fusarium_venenatum/circos_out/Fv_vs_Fv/refrence_generation
Conf=$(ls /home/connellj/git_repos/scripts/Fv_C-variants/Circos/Fv_Fv_circos_refrence_generation.conf.sh)
