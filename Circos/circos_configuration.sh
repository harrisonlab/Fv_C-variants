...
karyotype = /home/connellj/Circos/Fv_Fv_genome_edited.txt
...
# Include a 2D plot, this is where you tell circos what bases from genome 1 alighn to what bases in genome 2 

<<include /home/connellj/git_repos/emr_repos/Fv_C-variants/Circos/2d_plot.sh>>
