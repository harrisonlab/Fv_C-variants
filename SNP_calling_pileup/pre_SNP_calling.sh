...
### Cleanup
mv $name\_nomulti\_proper\_sorted\_nodup.txt $OutDir
mv $name\_nomulti\_proper\_sorted\_nodup_rg.bam $OutDir
mv $name\_nomulti\_proper\_sorted\_nodup_rg.bam.bai $OutDir
rm -rf $WorkDir
